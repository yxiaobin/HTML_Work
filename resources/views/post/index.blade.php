...
@section('content')
    ...
    <div class="card">
        <div class="card-header" style="margin-left: 11%"><h3>发表帖子</h3></div>
        @if (count($errors) > 0)
        ...
        @endif
        <div class="card-body" style="width: 80%; height: 300px;   margin-left:11%">
            <form action="{{url('post')}}/{{$member->id}}" method="post">
                ...
                <input type="submit" class="btn btn-primary" value="发表" style="margin-top: 20px">
            </form>
        </div>
    </div>
