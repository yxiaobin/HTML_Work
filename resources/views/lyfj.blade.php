...
@section('content')
    ...
    <div class="lyfj_content">
        ...
        <div class="lyfj_text" id = contenttext>
            <section id="11" >
                <div class="lyfj_text_img" style="background-image: url('images/mj001.jpg');">
                </div>
            ...
            <section id="22">
                <div class="lyfj_text_img" style="background-image: url('images/mj002.jpg');" >
                </div>
                <div class="lyfj_text_text">
            ...
            <section id="33">
                <div class="lyfj_text_img" style="background-image: url('images/mj003.jpg');" >
                </div>
                <div class="lyfj_text_text">
            ...
            <section id="44" style="display: block;">
                <div class="lyfj_text_img" style="background-image: url('images/mj004.jpg');" >
                </div>
                <div class="lyfj_text_text">
            ...
            <section id="55">
                <div class="lyfj_text_img" style="background-image: url('images/mj005.jpg');" >
                </div>
                <div class="lyfj_text_text">
