...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="images/mls002.jpg" alt="" style="height: 275px;">
                    <div class="caption">
                        <h3>第十一届黄河口马拉松</h3>
                        <p>十年东马，向东必赢...</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="images/dcxs002.jpg" alt="...">
                    <div class="caption">
                        <h3>房价再次增长增长</h3>
                        <p>四五月份以来，东营房价再次...</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="images/dcxs003.jpg" alt="...">
                    <div class="caption">
                        <h3>东营迎来四季最美之季</h3>
                        <p>四五月份是东营最...</p>
                        <p>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="images/ms004.jpg" alt="..." style="height: 221px;width: 409px;">
                    <div class="caption">
                        <h3>黄河刀鱼</h3>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="images/ly002.jpg" alt="..." style="height: 259px;">
                    <div class="caption">
                        <h3>黄河口生态旅游区</h3>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="images/ly003.jpg" alt="..." style="height: 259px;">
                    <div class="caption">
                        <h3>揽翠湖旅游度假区</h3>
                    </div>
                </div>
